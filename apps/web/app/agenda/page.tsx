    ...
    <main className="min-h-screen bg-[#f8f7fc] text-slate-950">
      <aside className="fixed inset-y-0 left-0 hidden w-64 flex-col bg-slate-950 p-5 text-white lg:flex">
        ...
        <nav className="mt-10 space-y-2">
          ...
          <a className="flex w-full rounded-xl bg-violet-600 px-4 py-3 text-left text-sm font-semibold"  href="/agenda">
            ◷ Agenda
          </a>

          <a className="flex w-full rounded-xl px-4 py-3 text-left text-sm font-medium text-slate-400"  href="/clientes">
            ♙ Clientes
          </a>
